...
const contributionTypes = [
  {
    ...
    description: 'Help others by sharing your detailed interview experience',
    icon: MessageSquare,
  ...
  },
  {
    ...
    description: 'Share suggestions to improve Campus Connect',
    icon: Lightbulb,
...
const impactStats = [
  ...
  { label: 'Resources Shared', value: '1,200+', icon: FileText },
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16 relative">
          <div className="absolute inset-0 flex items-center justify-center opacity-10">
            <Heart className="w-96 h-96 text-pink-500 animate-pulse" />
          </div>
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              <span className="bg-gradient-to-r from-pink-600 via-rose-600 to-orange-500 bg-clip-text text-transparent animate-gradient">
                Contribute to Campus Connect
              </span>
            </h1>
            
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed mb-8">
              Join thousands of students and professionals who are building the most comprehensive 
              interview preparation platform. Your contribution can change someone's career trajectory.
            </p>
              ...
              return (
                <Card key={type.id} className="group hover:shadow-xl transition-all duration-300 hover:scale-[1.02] bg-gradient-to-br from-white/80 to-white/60 dark:from-slate-800/80 dark:to-slate-700/60 backdrop-blur-sm border border-white/30 dark:border-slate-600/30 overflow-hidden">
                  ...
                  <CardContent>
                    ...
                    <Button className={`w-full bg-gradient-to-r ${type.color} text-white border-0 hover:scale-105 transition-transform duration-300`}>
